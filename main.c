...
{
    int choix_principal;
    printf("\t\tBIENVENUE sur notre plateforme de reservation  de bus en ligne . simplifiez  votre voyage  en reservant vos billets en quelques clics \n");
    printf("\t\t===========================\n\n");
        ...
        case 1:    //appel aux fonctions
            ...
            while(1)//boucle pour demander a l'utilisateur veut faire une autre reservation
            {
                ...
                case 1:
                    ...
                    break;
                case 0:
                    printf("votre reservation a ete effectuer!");
                    exit(0);
                default:
